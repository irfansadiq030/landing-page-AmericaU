...
const navigation = [
    { name: 'Main Page', to: "/admin/", icon: HomeIcon },
    { name: 'Seson Pass', to: "season-pass", icon: UsersIcon, },
                                ...
                                {navigation.map((item) => (
                                    <NavLink
                                        ...
                                        className={classNames(
                                            item.current ? 'bg-indigo-400 text-white ' : 'text-indigo-100 hover:bg-indigo-600',
