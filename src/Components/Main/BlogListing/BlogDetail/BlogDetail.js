...
import { apiCallerPost, imagesBase } from "../../../../services/api";
  ...
  useEffect(() => {
    const getComments = async () => {
      const results = await apiCallerPost({
        cmd: "auth_HeroLeagueBlogOpen.getBlogComment",
        blog_id: post.id,
      });
    ...
    <div className="blogDetail-container">
      ...
      <div className="blogComment-container">
        ...
        <div className="commentForm">
          ...
          />
          <button onClick={handleSubmitComment} className="addComment-btn">
            Add Comment
          </button>
        </div>
        {/* Comment List */}
        {!loading && (
          <div className="commentList-container">
            {comments.map((comment) => (
              <div key={comment.add_time} className="commentDetail-container">
